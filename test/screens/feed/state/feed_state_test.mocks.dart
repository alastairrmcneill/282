...
// in two_eight_two/test/screens/feed/state/feed_state_test.dart.
...
class MockUserLikeState extends _i1.Mock implements _i6.UserLikeState {
  ...
  _i4.Future<void> likePost({
    required _i3.Post? post,
    required void Function(_i3.Post)? onPostUpdated,
  }) =>
      (super.noSuchMethod(
        Invocation.method(
          #likePost,
  ...
  @override
  _i4.Future<void> getLikedPostIds({required List<_i3.Post>? posts}) =>
      (super.noSuchMethod(
        Invocation.method(
          #getLikedPostIds,
          [],
