  ...
  await SentryFlutter.init(
    (options) {
      ...
      options.beforeSend = (event, hint) {
        // Some transient network failures (e.g. a Supabase storage image
        // timing out, or a Postgrest request hitting a stale socket) are
        // thrown outside FlutterError.onError's reach and would otherwise
        // still get reported as unresolved production errors.
